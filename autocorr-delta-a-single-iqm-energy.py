...
folder_name = f"energy-data_L{L}-iqm"
...
def qc_qiskit(initial_state, L, g, hs, phis, t, qubit, echo=False, noise_model=None):
    ...
    initial_layout = Layout(
        {
            ...
            circ.qubits[16]: 8, #8
            circ.qubits[17]: 9, #9
            circ.qubits[18]: 10, #10
            circ.qubits[19]: 14, #14
        }
    )
    ...
    # layout_filename = f"{folder_name}/circuit_layout_t{t}_{echo_str}_opt{optimization_level}_{backend_name}_iqm.png"
